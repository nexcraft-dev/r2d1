...
public enum D1ValueType {
  ...
  public IndexValue readIndexValue(String fieldName, @Nullable Object value) {
    if (value == null) {
  ...
  public static D1ValueType fromJavaType(String fieldName, Class<?> javaType) {
