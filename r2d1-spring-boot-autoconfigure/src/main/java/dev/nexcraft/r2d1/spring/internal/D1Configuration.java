...
public class D1Configuration {
  ...
  D1IndexStore d1IndexStore(R2D1D1Properties properties, ObjectProvider<HttpClient> httpClients) {
    D1Config config =
        new D1Config(
    ...
    return client == null ? new D1IndexStore(config) : new D1IndexStore(config, client);
  }
