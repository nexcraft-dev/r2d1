...
record CloudflareIntegrationConfig(R2Config r2, D1Config d1) {

  private static final String CONFIRMATION = "R2D1_IT_CONFIRM_DEDICATED_RESOURCES";

  static CloudflareIntegrationConfig load() {
