...
public final class IntegrationSupport {
  ...
  public static <T extends @Nullable Object> T await(CompletionStage<T> stage) {
    try {
  ...
  public static void clearR2Collection(DocumentStore store, String collection) {
  ...
  public static void clearD1Collection(
      D1IndexStore store, Class<?> documentType, String collection) {
    await(store.initialize(documentType));
    await(store.clear(collection));
  }

  public static IndexEntry entry(String collection, Value document) {
  ...
  public static IndexQuery sortedCountryQuery(String collection, String country, int limit) {
  ...
  public static IndexQuery sortedCountryQuery(
